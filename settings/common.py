...
ADMINS = getaddresses([env("DJANGO_ADMINS", default='circle Admin <admin@example.com>')])
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'circle.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "circle.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/circle"),
}
