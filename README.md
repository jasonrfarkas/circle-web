...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:jasonrfarkas/circle-web.git; cd circle-web; fab init
...
[contributing]: http://github.com/jasonrfarkas/circle-web/tree/master/CONTRIBUTING.md
